...
<table class="order-details">
	...
	<tbody>
		<?php foreach ($this->get_order_items() as $item_id => $item) :
			$product_id = isset($item['product_id']) ? $item['product_id'] : $item_id;
			$printareas = get_field("product_extra_details", $product_id);
		?>
			<tr class="<?php echo apply_filters('wpo_wcpdf_item_row_class', 'item-' . $item_id, esc_attr($this->get_type()), $this->order, $item_id); ?>">
				<td class="product">
					...
					<div class="product_ar_order_details"><?php echo $printareas; ?></div>
