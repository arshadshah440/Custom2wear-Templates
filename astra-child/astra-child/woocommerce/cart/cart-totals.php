...
?>
<h5 class="page_headings_titles"><?php esc_html_e('Cart Totals', 'woocommerce'); ?></h5>
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>" id="cart_total">
    ...
    <div class="wc-proceed-to-checkout" id="proctochout_ar">
